...
const chartPlaceholder = new URL("../assets/photo_bp.webp", import.meta.url)
  .href;
const logo1 = new URL("../assets/fooz_logo.svg", import.meta.url).href;
const logo2 = new URL("../assets/Geniusee.svg", import.meta.url).href;
const logo3 = new URL("../assets/urban.svg", import.meta.url).href;
const logo4 = new URL("../assets/dots.svg", import.meta.url).href;
const logo5 = new URL("../assets/chrono.webp", import.meta.url).href;
...
const pillars = [
  {
    ...
    items: [
      ...
      "Clear separation of Stateful (Container) and Stateless (Presentational) components.",
      "Effective use of React Hooks (e.g., useState, useEffect, useContext) for logic reuse.",
      "Creating highly reusable and composable components.",
      "Implementing Storybook for isolated component development and documentation.",
    ],
  },
  {
    title: "Performance & Optimization",
    items: [
      "Optimizing rendering with React.memo, useCallback, and useMemo.",
      "Efficient state management to prevent unnecessary re-renders (e.g., using Redux Toolkit or Zustand).",
      "Implementing Code Splitting and Lazy Loading with React.lazy and Suspense.",
      "Minimizing prop drilling by utilizing the Context API or a global state manager.",
      "Profiling performance with the React Developer Tools.",
    ],
  },
  {
    title: "Testing & Maintainability",
    items: [
      "Writing comprehensive Unit Tests for components (e.g., using Jest and React Testing Library).",
      "Implementing End-to-End (E2E) Tests with tools like Cypress or Playwright.",
      "Enforcing code quality and consistency with ESLint and Prettier.",
      "Adhering to modern TypeScript best practices for type safety.",
      "Establishing clear component directory structure and naming conventions.",
    ],
  },
];
      ...
      <section className="px-6 py-20 bg-[#111111] text-white sm:px-10 lg:px-20">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-3xl font-bold mb-10">
            The Three Pillars of React Excellence
          </h2>
